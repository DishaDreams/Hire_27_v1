        ...
        <div class="row justify-content-between">
            <div class="col-xxl-3 col-xl-4 col-lg-5 mb-xl-0 mb-5">
                ...
                <form id="newsLetterForm">
                    ...
                    @if(!empty($settings['facebook_url']))
                        <a href="{{ $settings['facebook_url'] }}" target="_blank" class="social-icon-box d-flex align-items-center justify-content-center me-2">
                            <i class="fa-brands fa-facebook-f footer-navbar-color text-dark"></i>
                        </a>
                    @endif
                    @if(!empty($settings['twitter_url']))
                        <a href="{{ $settings['twitter_url'] }}" target="_blank" class="social-icon-box d-flex align-items-center justify-content-center me-2">
                            <i class="fa-brands fa-twitter footer-navbar-color text-dark"></i>
                        </a>
                    @endif
                    @if(!empty($settings['google_plus_url']))
                        <a href="{{ $settings['google_plus_url'] }}" target="_blank" class="social-icon-box d-flex align-items-center justify-content-center me-2">
                            <i class="fa-brands fa-google footer-navbar-color text-dark"></i>
                        </a>
                    @endif
                    @if(!empty($settings['linkedIn_url']))
                        <a href="{{ $settings['linkedIn_url'] }}" target="_blank" class="social-icon-box d-flex align-items-center justify-content-center me-2">
                            <i class="fa-brands fa-linkedin-in footer-navbar-color text-dark"></i>
                        </a>

                    @endif
                    <a href="https://www.medium.com/@1XLUniverse/" target="_blank" class="social-icon-box d-flex align-items-center justify-content-center me-2">
                        <i class="fa-brands fa-medium footer-navbar-color text-dark"></i>
                    </a>
                    <a href="https://www.youtube.com/@1XLUniverse/" target="_blank" class="social-icon-box d-flex align-items-center justify-content-center me-2">
                        <i class="fa-brands fa-youtube footer-navbar-color text-dark"></i>
                    </a>
                    <a href="https://www.x.com/1XLUniverse/" target="_blank" class="social-icon-box d-flex align-items-center justify-content-center me-2">
                        <i class="fa-brands fa-x footer-navbar-color text-dark"></i>
                    </a>
                    <a href="https://www.reddit.com/user/1XLUniverse/" target="_blank" class="social-icon-box d-flex align-items-center justify-content-center me-2">
                        <i class="fa-brands fa-reddit footer-navbar-color text-dark"></i>
                    </a>
                 
                </div>

                <div class="social-icon d-flex mt-4">
                    <a href="https://www.pinterest.com/1XLUniverse/" target="_blank" class="social-icon-box d-flex align-items-center justify-content-center me-2">
                        <i class="fa-brands fa-pinterest footer-navbar-color text-dark"></i>
                    </a>
                    <a href="https://www.quora.com/profile/1XLUniverse/" target="_blank" class="social-icon-box d-flex align-items-center justify-content-center me-2">
                        <i class="fa-brands fa-quora footer-navbar-color text-dark"></i>
                    </a>
                   
                    <a href="https://www.discord.com/channels/@1XLUniverse/" target="_blank" class="social-icon-box d-flex align-items-center justify-content-center me-2">
                        <i class="fa-brands fa-discord footer-navbar-color text-dark"></i>
                    </a>
                    <a href="https://whatsapp.com/channel/0029VaLoJ1SLCoX4iyiW0R0c" target="_blank" class="social-icon-box d-flex align-items-center justify-content-center me-2">
                        <i class="fa-brands fa-whatsapp footer-navbar-color text-dark"></i>
                    </a>
                    <a href="https://www.threads.net/@1XLUniverse/" target="_blank" class="social-icon-box d-flex align-items-center justify-content-center me-2">
                        <i class="fa-brands fa-threads footer-navbar-color text-dark"></i>
                    </a>
            </div>
            </div>
            ...
            <div class="col-12 text-center mt-lg-5 mt-4
                ...
                <p class="pt-4 pb-4 fs-14">
                    ...
                    {{ __('web.footer.all_rights_reserved') }}. One XL Info LLP
                </p>
            </div>
        </div>
    </div>

                                    ...
                                    @foreach($faqLists as $key => $faqList)
                                        <div class="accordion-item br-10">
                                            <h2 class="accordion-header" id="heading-{{$key}}">
                                                <button class="accordion-button collapsed fs-18  p-4" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-{{$key}}" aria-expanded="false" aria-controls="collapse-{{$key}}"> {{ html_entity_decode($faqList->title) }}
                                                </button>
                                            </h2>

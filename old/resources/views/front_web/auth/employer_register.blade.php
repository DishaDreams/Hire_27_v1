                    ...
                    <div class="col-xl-6 col-lg-8 mx-auto">
                        ...
                        <form method="POST" action="{{ route('front.login') }}" id="addEmployerNewForm"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control fs-14 text-gray br-10" name="first_name"
                                               id="employerFirstName" placeholder="Enter name"
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                        <label for="employerPassword" class="fs-16 text-secondary mb-2">{{ __('web.common.password') }}
                                            <span class="text-danger">*</span>
                                        </label>
                                        <div class="input-group">
                                            <input type="password" name="password" placeholder="Enter password" class="form-control fs-14 text-gray br-10" id="employerPassword" required onkeypress="return avoidSpace(event)">
                                            <button type="button" style="border: 1px solid #ffff; border-radius: 10px; background-color: #ffffff; color: #6c757d; font-size: 14px;" onclick="togglePasswordVisibility('employerPassword')">
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                        <label for="employerConfirmPassword" class="fs-16 text-secondary mb-2">{{ __('web.common.confirm_password') }}
                                            <span class="text-danger">*</span>
                                        </label>
                                        <div class="input-group">
                                            <input type="password" name="password_confirmation" placeholder="Confirm password" class="form-control fs-14 text-gray br-10" id="employerConfirmPassword" required onkeypress="return avoidSpace(event)">
                                            <button type="button" style="border: 1px solid #ffff; border-radius: 10px; background-color: #ffffff; color: #6c757d; font-size: 14px;" onclick="togglePasswordVisibility('employerConfirmPassword')">
...
<script>
    function togglePasswordVisibility(inputId) {
        ...
        var iconId = inputId === 'employerPassword' ? 'passwordToggleIcon' : 'confirmPasswordToggleIcon';

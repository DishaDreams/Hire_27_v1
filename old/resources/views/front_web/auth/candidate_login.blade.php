                        ...
                        <form method="POST" action="{{ route('front.login') }}" id="candidateForm"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-4">
                                  ...
                                  <div class="col-md-12 mb-4">
                                    <div class="form-group">
                                        <label for="password" class="fs-16 text-secondary mb-2">{{ __('web.common.password') }}
                                            <span class="text-danger">*</span>
                                        </label>
                                        <div class="input-group">
                                            <input type="password" name="password" class="form-control fs-14 text-gray br-10" id="password" placeholder="Your Password" value="{{ (Cookie::get('password') !== null) ? Cookie::get('password') : '' }}" required>
                                            <button type="button" style="border: 1px solid #ffff; border-radius: 10px; background-color: #ffffff; color: #6c757d; font-size: 14px;" onclick="togglePasswordVisibility('password')">

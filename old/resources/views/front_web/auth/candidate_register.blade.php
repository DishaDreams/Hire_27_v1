                        ...
                        <form method="POST" id="addCandidateNewForm"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-4">
                                 ...
                                 <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                        <label for="candidatePassword" class="fs-16 text-secondary mb-2">{{ __('web.common.password') }}
                                            <span class="text-danger">*</span>
                                        </label>
                                        <div class="input-group">
                                            <input type="password" name="password" placeholder="Enter password" class="form-control fs-14 text-gray br-10" id="candidatePassword" required onkeypress="return avoidSpace(event)">
                                            <button type="button" style="border: 1px solid #ffff; border-radius: 10px; background-color: #ffffff; color: #6c757d; font-size: 14px;" onclick="togglePasswordVisibility('candidatePassword', 'eyeIcon')">
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                        <label for="candidateConfirmPassword" class="fs-16 text-secondary mb-2">{{ __('web.common.confirm_password') }}
                                            <span class="text-danger">*</span>
                                        </label>
                                        <div class="input-group">
                                            <input type="password" name="password_confirmation" class="form-control fs-14 text-gray br-10" id="candidateConfirmPassword" placeholder="Confirm password" required onkeypress="return avoidSpace(event)">
                                            <button type="button" style="border: 1px solid #ffff; border-radius: 10px; background-color: #ffffff; color: #6c757d; font-size: 14px;" onclick="togglePasswordVisibility('candidateConfirmPassword', 'confirmEyeIcon')">
